...
class Interface(object):
    ...
    def make_background(self):
        image = pg.Surface((W*20,H*20)).convert()
        image.set_colorkey((255,0,255))
        image.fill((255,0,255),(20,20,W*20-40,H*20-40))
        for i in range(W+1):
            image.fill((255,0,0),(20+20*i,20,2,H*20-40+2))
        for i in range(H+1):
            image.fill((255,0,0),(20,20+20*i,W*20-40,2))
        return image
    ...
    def render_text(self,specific=None):
        ...
        text = {"START"   : ["Place your start point:",(10,1)],
                ...
                "MOVE"    : ["Move type: {}".format(self.piece_type.capitalize()),(320,H*19+13)],
                "TIME"    : ["Time (ms): {}".format(self.time_end-self.time_start),(100,H*19+13)],
                "FAILED"  : ["No solution.",(20,H*19+13)],
                "SOLVED"  : ["Steps: {}".format(len(self.solution)),(20,H*19+13)]}
        if specific:
    ...
    def left_button_clicked(self):
        if pg.Rect(20,20,W*20-40,H*20-40).collidepoint(self.mouse):
            if self.mode == "START":
